...
export function Login() {
    ...
    return(
        <div className="flex flex-col h-[100vh] justify-center items-center">
            ...
            <Form className="flex flex-col gap-2 p-6 bg-[#121212] rounded-lg transition-transform transform hover:scale-105 hover:border hover:border-black w-[90%]">
                ...
                <div className="flex items-center gap-2 p-2 bg-[#0a0a0a] rounded-lg shadow-inner">
                    ...
                    <input autoComplete="off" placeholder="Username" className="bg-transparent border-none outline-none w-full text-gray-300" type="text" />
                </div>
                <div className="flex items-center gap-2 p-2 bg-[#0a0a0a] rounded-lg shadow-inner">
                    <svg className="w-4 h-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                        <path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"></path>
                    </svg>
                    <input placeholder="Password" className="bg-transparent border-none outline-none w-full text-gray-300" type="password" />
                </div>
                <div className="flex justify-center mt-6">
                    <button className="px-4 py-2 bg-[#1c1c1c] rounded-md hover:bg-black text-white transition duration-200">Login</button>
